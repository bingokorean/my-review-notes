...
목차
* 네이버 쇼핑 및 카테고리 분류 문제의 개요
* 카테고리 분류 문제를 AI로 풀기위한 모티베이션 소개
* 데이터 셋 소개 및 데이터를 정제하기 위한 과정과 기술 설명
* 모델 및 훈련 과정, 관련 기술 설명
* 모델 및 데이터의 품질 및 성능을 측정하고 관리하는 기법 소개
* 인퍼런스를 위한 환경 및 파이프라인 설명, 모델 관리 방법 소개
* 앞으로의 추가 과제 소개
