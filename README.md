코딩, 머신러닝, 텍스트 마이닝을 [코드](#CODE), [페이퍼](#PAPER), [미디어](#MEDIA)와 같이 다양한 측면에서 배우고 내용을 정리하고 있습니다. 이러한 리뷰를 통해 반복적인 복습을 유도하고 업데이트를 통한 성취감으로 배움의 흥미를 더 느끼게 해주며 예전에 배운 것을 언제든지 빨리 찾을 수 있는 레퍼런스 기능을 가질 수 있습니다.
