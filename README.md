코딩, 머신러닝, 텍스트 마이닝을 [CODE](#CODE), [PAPER](#PAPER), [MEDIA](#MEDIA)와 같이 다양한 측면에서 배우고 내용을 정리하고 있습니다. 이러한 리뷰를 통해 반복적인 복습을 유도하고, 업데이트를 통한 성취감으로 배움의 흥미를 더 느끼게 해주며, 예전에 배운 것을 언제든지 빨리 찾을 수 있는 레퍼런스 기능과 함께 거대한 지식트리를 구축할 수 있습니다.

# CODE

:runner: Review of my codes :family: Review of others' codes
...
* Korean Lexical analyzer with Recursion [[.ipynb](https://nbviewer.jupyter.org/github/gritmind/review/blob/master/code/etc/codes/lexical_recursion.ipynb)] | 2018.11
* POS tagger with Viterbi algorithm [[.ipynb](https://nbviewer.jupyter.org/github/gritmind/review/blob/master/code/etc/codes/pos_viterbi.ipynb)] | 2018.11
...
* [Feed-Forward Networks with Attention Can Solve Some Long-Term Memory Problems](https://github.com/gritmind/review/blob/master/paper/paper/feed-forward-with-attention.md) (C.Raffel, *ICLR(workshop)* 2016) | 2018
...
# References
[Lazy Programmer](https://lazyprogrammer.me/) / [MachineLearningMastery](https://machinelearningmastery.com/)
